...
get_ipython().run_line_magic('timeit', 'GaussianRandomProjection(random_state=42).fit(X)')
print("SparseRandomProjection fit")
get_ipython().run_line_magic('timeit', 'SparseRandomProjection(random_state=42).fit(X)')
...
get_ipython().run_line_magic('timeit', 'gaussian_rnd_proj.transform(X)')
print("SparseRandomProjection transform")
get_ipython().run_line_magic('timeit', 'sparse_rnd_proj.transform(X)')
...
get_ipython().run_line_magic('time', 'rnd_clf.fit(X_train, y_train)')
...
get_ipython().run_line_magic('time', 'rnd_clf_with_pca.fit(X_train_reduced, y_train)')
...
get_ipython().run_line_magic('time', 'sgd_clf.fit(X_train, y_train)')
...
get_ipython().run_line_magic('time', 'sgd_clf_with_pca.fit(X_train_reduced, y_train)')
...
tsne = TSNE(n_components=2, init="random", learning_rate="auto",
            random_state=42)
get_ipython().run_line_magic('time', 'X_reduced = tsne.fit_transform(X_sample)')
...
get_ipython().run_line_magic('time', 'X_pca_reduced = pca.fit_transform(X_sample)')
...
get_ipython().run_line_magic('time', 'X_lle_reduced = lle.fit_transform(X_sample)')
...
get_ipython().run_line_magic('time', 'X_pca_lle_reduced = pca_lle.fit_transform(X_sample)')
...
get_ipython().run_line_magic('time', 'X_mds_reduced = MDS(n_components=2, random_state=42).fit_transform(X_sample)')
...
get_ipython().run_line_magic('time', 'X_pca_mds_reduced = pca_mds.fit_transform(X_sample)')
...
get_ipython().run_line_magic('time', 'X_lda_reduced = lda.fit_transform(X_sample, y_sample)')
